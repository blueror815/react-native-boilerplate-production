...
export default class StyledScreen extends Component {
  ...
  static navigatorButtons = {
    rightButtons: [{
      icon: require('../../assets/images/navicon_edit.png'),
      id: 'compose',
  ...
  render() {
    return (
      <ScrollView style={styles.container}>
        <Image style={{width: undefined, height: 100}} source={require('../../assets/images/colors.png')} />
  ...
  onSetTitleImagePress() {
    this.props.navigator.setTitle({
      title: 'title',
      titleImage: require('../../assets/images/one.png'),
    })
  }
